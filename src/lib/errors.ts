...
const MAP: [RegExp, string][] = [
  ...
  [/only expenses can be edited/i, '结算记录不能修改，只能冲销。'],
  [/payer is not a member/i, '付款人不是这个账本的成员。'],
  [/invalid payer_share/i, '拆分比例必须在 0 到 100% 之间。'],
  [/amount must be positive/i, '金额必须大于 0。'],
  [/invalid member name/i, '名字只能是 Zod 或 Sylvia。'],
